    ...
    if (print_tables) {
      if (transformation) {
        ...
        table_gt <- list(
          ...
          list(
            table = html_table_gt(
              data = tables$tab1, title = paste("Table 2: Comparison between Controls and Wild Type as to",
          ...
          list(
            table = html_table_gt(
              data = tables$tab2, title = paste("Table 3: Comparison between Doses as to",
                                                signal()$input_data$endpoint),
              footer = footer, include_summary = T, summary_only = F, transformation = T, analysis_type = analysis_type,
              endpoint = signal()$input_data$endpoint
            )
          ...
          list(
            table = html_table_gt(
              data = tables$tab3, title = paste("Table 4: Comparison between Doses and Controls/Wild Type as to",
                                                signal()$input_data$endpoint),
        ...
        table_gt <- list(
          list(
            table = html_table_gt(
              data = tables$tab1, title = paste("Table 1: Comparison between Controls and Wild Type as to",
                                                signal()$input_data$endpoint),
          ...
          list(
            table = html_table_gt(
              data = tables$tab2, title = paste("Table 2: Comparison between Doses as to",
                                                signal()$input_data$endpoint),
              footer = footer, include_summary = T, summary_only = F, transformation = F, analysis_type = analysis_type,
              endpoint = signal()$input_data$endpoint
            )
          ...
          list(
            table = html_table_gt(
              data = tables$tab3, title = paste("Table 3: Comparison between Doses and Controls/Wild Type as to",
                                                signal()$input_data$endpoint),
