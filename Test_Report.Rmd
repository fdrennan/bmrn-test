...
params:
  ...
  uuid: '9a1324e1-a509-4759-a84a-00222a9a17df' 
...
```{r, echo = FALSE, error=F, warning=FALSE, fig.width=9, fig.height=5, fig.cap=prism_caption}
transformed_data = data$plot$data$transformed_data
...
prism = prism_plot(data = transformed_data, tables = data$tables$tables, 
                   ...
                   time_sel =  time,
                   endpoint = data$plot$endpoint, format = 'html', 
...
tab1 = data$tables$tables$tab1 %>% filter(`Time Points` %in% data$inputs$timeTreatmentSelectorsTable)
...
<br>
```{r, echo = F, error=F, warning=FALSE, fig.width=9, fig.height=6}
tab2 = data$tables$tables$tab2 %>% filter(`Time Points` %in% data$inputs$timeTreatmentSelectorsTable)
...
tab3 = data$tables$tables$tab3 %>% filter(`Time Points` %in% data$inputs$timeTreatmentSelectorsTable)
