...
params:
  ...
  uuid: '8bcb82fc-7964-4bb1-8fc4-e813ea4a8333' 
...
```{r, echo = FALSE, error=F, warning=FALSE, fig.width=9, fig.height=6, fig.align='center',fig.cap=prism_caption_bar, message=FALSE}
knitr::include_graphics(paste0(plots_path,'/prism_plots_bar.jpg'))
```

\newpage

```{r, echo = FALSE, error=F, warning=FALSE, fig.width=9, fig.height=6,fig.align='center', fig.cap=prism_caption_box, message=FALSE}
