...
params:
  ...
  uuid: 'd482dcc3-0519-46c1-a172-bdbc4410676a'
...
contrasts =  data.frame(
    ...
    `Multiple Testing Procedure` = c('NA','NA', 'None',"Dunnett",'NA','None','Mvt','NA','Dunnet'),
  check.names = FALSE) %>%
...
```{r, echo = FALSE, error=F, warning=FALSE,out.height = 575, out.width=800}
knitr::include_graphics("Flowcharts_smaller.png")
```
