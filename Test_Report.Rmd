...
```{r, echo = FALSE, error=F, warning=FALSE, fig.width=9, fig.height=10, fig.align='center',fig.cap=prism_caption_bar, message=FALSE}
...
knitr::include_graphics(paste0(plots_path,'/prism_plots_box.jpg'))
